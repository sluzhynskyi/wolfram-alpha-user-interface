...
var Fragment = P(function(_) {
  _.init = function(withDir, oppDir, dir) {
    ...
    // To lib the jquery collection for a fragment, accumulate elements
...
function getInterface(v) {
   ...
   * components math or math or text field, returns an API object for it (else, null).
   *
...
var MathCommand = P(MathElement, function(_, super_) {
  ...
  /*
    ...
    your HTML inputs would have to have '&amp;123'.
  */
  ...
  _.html = function() {
    ...
    //
    // See html.test.js for example inputs and intended outputs.
    //
 ...
 * Represents flat strings of typically serif-font_old Roman characters, as
...
LatexCmds.textsc =
  makeTextBlock('\\textsc', 'span', 'style="font_old-variant:small-caps" class="mq-text-mode"');
LatexCmds.uppercase =
...
LatexCmds.Upsih = //'cos it makes sense to me
  bind(Symbol,'\\Upsilon ','<var style="font_old-family: serif">&upsih;</var>'); //Symbola's 'upsilon with a hook' is a capital Y without hooks :(
...
//fonts
LatexCmds.mathrm = bind(Style, '\\mathrm', 'span', 'class="mq-roman mq-font_old"');
LatexCmds.mathit = bind(Style, '\\mathit', 'i', 'class="mq-font_old"');
LatexCmds.mathbf = bind(Style, '\\mathbf', 'b', 'class="mq-font_old"');
LatexCmds.mathsf = bind(Style, '\\mathsf', 'span', 'class="mq-sans-serif mq-font_old"');
LatexCmds.mathtt = bind(Style, '\\mathtt', 'span', 'class="mq-monospace mq-font_old"');
//text-decoration
